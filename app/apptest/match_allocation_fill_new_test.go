...
func Test_Fill_1_new(t *testing.T) {
	...
	msgB := order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 1e8, 1e8)
	_, err := testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)

	oidS := GetOrderId(addr1, 0, ctx)
	msgS := order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 1e8, 1e8)
	...
	assert.Equal(int64(99999e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99998.9995e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99999e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000.9995e8), GetAvail(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(100001e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99997.9995e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99997.9990e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99998e8), GetAvail(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100002e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99996.9990e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99996.9985e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99997e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100002.9985e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Fill_2_new(t *testing.T) {
	...
	oidS := GetOrderId(addr1, 0, ctx)
	msgS := order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 1e8, 100e8)
	msgS.TimeInForce = 3
	_, err := testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
...
func Test_Fill_3_new(t *testing.T) {
	...
	*/
	...
	for i := 0; i < 3; i++ {
		oid := GetOrderId(addr0, int64(i), ctx)
		msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", int64(i+3)*1e8, int64(i+1)*1e8)
		if i%1 == 0 {
			msg.TimeInForce = 3
		}
		_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99974e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(26e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99981.9910e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99994e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100017.9910e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Fill_4_new(t *testing.T) {
	...
	*/
	...
	for i := 0; i < 3; i++ {
		oid := GetOrderId(addr0, int64(i), ctx)
		msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 3e8, 10e8)
		_, err := testClient.DeliverTxSync(msg, testApp.Codec)
		assert.NoError(err)
	}

	oidS1 := GetOrderId(addr1, 0, ctx)
	msgS1 := order.NewNewOrderMsg(addr1, oidS1, 2, "BTC-000_AXC", 1e8, 15e8)
	msgS1.TimeInForce = 3
	_, err := testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)

	oidS2 := GetOrderId(addr1, 1, ctx)
	msgS2 := order.NewNewOrderMsg(addr1, oidS2, 2, "BTC-000_AXC", 2e8, 7e8)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99909.967e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(24e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99978e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100065.9670e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Fill_5_new(t *testing.T) {
	...
	*/
	...
	msgB1 := order.NewNewOrderMsg(addr0, oidB1, 1, "BTC-000_AXC", 3e8, 10e8)
	_, err := testClient.DeliverTxSync(msgB1, testApp.Codec)
	assert.NoError(err)

	oidB2 := GetOrderId(addr1, 0, ctx)
	msgB2 := order.NewNewOrderMsg(addr1, oidB2, 1, "BTC-000_AXC", 3e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB2, testApp.Codec)
	assert.NoError(err)

	oidB3 := GetOrderId(addr2, 0, ctx)
	msgB3 := order.NewNewOrderMsg(addr2, oidB3, 1, "BTC-000_AXC", 3e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB3, testApp.Codec)
	assert.NoError(err)

	oidS1 := GetOrderId(addr3, 0, ctx)
	msgS1 := order.NewNewOrderMsg(addr3, oidS1, 2, "BTC-000_AXC", 1e8, 15e8)
	msgS1.TimeInForce = 3
	_, err = testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)

	oidS2 := GetOrderId(addr3, 1, ctx)
	msgS2 := order.NewNewOrderMsg(addr3, oidS2, 2, "BTC-000_AXC", 2e8, 7e8)
	_, err = testClient.DeliverTxSync(msgS2, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(99970e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(30e8), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99970e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(30e8), GetLocked(ctx, addr2, "AXC"))
	...
	assert.Equal(int64(9996998899990), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(7.9998e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100007.3333e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(9996998900005), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(8.0001e8), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(100007.3333e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(9996998900005), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(8.0001e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(99978e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100065.9670e8), GetAvail(ctx, addr3, "AXC"))
...
func Test_Fill_6_new(t *testing.T) {
	...
	oidS := GetOrderId(addr1, 0, ctx)
	msgS := order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 10e8, 5e8)
	_, err = testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99900e8), GetAvail(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99899.975e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(50e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99995e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100049.975e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	oidS = GetOrderId(addr1, 1, ctx)
	msgS = order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 8e8, 10e8)
	_, err = testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(99899.9500e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100099.9500e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	oidB = GetOrderId(addr0, 1, ctx)
	msgB = order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 9e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100010e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99809.9500e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100099.9500e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100015e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99814.9300e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(45e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100139.93e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	oidS = GetOrderId(addr1, 2, ctx)
	msgS = order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 5e8, 10e8)
	_, err = testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(99814.9075e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100184.9075e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	oidB = GetOrderId(addr0, 2, ctx)
	msgB = order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 12e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100020e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99694.9075e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(120e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100184.9075e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(99729.8950e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(60e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr1, "BTC-000"))
...
/*
test #6: non-axc trade, both have axc balance
*/
func Test_Fill_7_new(t *testing.T) {
	...
	assert.Equal(int64(100010e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99999.9500e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(100050e8), GetAvail(ctx, addr1, "ETH-000"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99999.6250e8), GetAvail(ctx, addr1, "AXC"))
}
