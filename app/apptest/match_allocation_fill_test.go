...
func Test_Fill_6(t *testing.T) {
	...
	*/
	...
	assert.Equal(int64(99902.45125e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100097.45125e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	assert.Equal(int64(100010e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99812.45125e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100097.45125e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100015e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99812.42875e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(45e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100142.42875e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	assert.Equal(int64(99814.657375e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100185.157375e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	*/
	...
	assert.Equal(int64(100020e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99694.657375e8), GetAvail(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(9970974743125), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(60e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(10023002243125), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
