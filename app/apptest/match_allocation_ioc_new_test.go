...
func Test_IOC_2_new(t *testing.T) {
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99999.9995e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
...
func Test_IOC_3_new(t *testing.T) {
	...
	oidB := GetOrderId(addr0, 0, ctx)
	msgB := order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 1e8, 2e8)
	msgB.TimeInForce = 3
	_, err := testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99998e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(2e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99999e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(1e8), GetLocked(ctx, addr1, "BTC-000"))
...
func Test_IOC_4_new(t *testing.T) {
	...
	*/
	...
	for i := 0; i < 5; i++ {
		oid := GetOrderId(addr0, int64(i), ctx)
		msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", int64(i+1)*1e8, int64(i+2)*1e8)
		msg.TimeInForce = 3
		_, err := testClient.DeliverTxSync(msg, testApp.Codec)
		assert.NoError(err)
	}
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99930e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(70e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99959.9797e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100039.9800e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_IOC_5_new(t *testing.T) {
	...
	*/
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99848e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(152e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99939.9700e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99980e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100059.9700e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
