...
func Test_Maker_Buy_1a(t *testing.T) {
	...
	*/
	...
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 11e8, 100e8)
	...
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 12e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 2, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 9e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 3, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 10e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(98350e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1650e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(98374.5050e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(635e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100989.5050e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Buy_1b(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 11e8, 35e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 12e8, 59e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(98657e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1343e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100090e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(98715.5050e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(294e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100989.5050e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Maker_Buy_1c(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 12e8, 75e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 11e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(98575e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1425e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100090e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(98574.49412502e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(360e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(101064.49412502e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
...
func Test_Maker_Buy_2a(t *testing.T) {
	...
	*/
	...
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 9e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 75e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99025e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(975e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99024.6250e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99925e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100749.6250e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Maker_Buy_2b(t *testing.T) {
	...
	*/
	...
	msg = order.NewNewOrderMsg(addr2, oid, 1, "BTC-000_AXC", 10e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	msg = order.NewNewOrderMsg(addr3, oid, 1, "BTC-000_AXC", 10e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99525e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(475e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99925e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(75e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99750e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(250e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99750e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(250e8), GetLocked(ctx, addr3, "AXC"))
	...
	assert.Equal(int64(99524.8750e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99925e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100749.6250e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100025e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99749.8750e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100025e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99749.8750e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "AXC"))
}
...
func Test_Maker_Buy_2c(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
...
func Test_Maker_Buy_2d(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 1, "BTC-000_AXC", 9e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 1, "BTC-000_AXC", 9e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 18e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 2, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99395e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(605e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99907e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(93e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99775e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99775e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr3, "AXC"))
	...
	assert.Equal(int64(99412.8065e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(200e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99907e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100836.5815e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100025e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99774.8875e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100025e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99774.8875e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "AXC"))
}
...
func Test_Maker_Buy_2e(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99325e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(675e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99349.83499985e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(319.9997e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99940e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100539.7300e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100011.6667e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99774.94749985e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(119.9997e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100011.6666e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99774.94750030e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(120.0006e8), GetLocked(ctx, addr3, "AXC"))
}
...
func Test_Maker_Buy_2f(t *testing.T) {
	...
	*/
	...
	assert.Equal(int64(99349.7750e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(200e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99940e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100539.73e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100010e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99774.9550e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(135e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(99775e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr3, "AXC"))
}
...
func Test_Maker_Buy_3a(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 30e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 35e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 11e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 13e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 7e8, 51e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99475e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(525e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "AXC"))
	...
	assert.Equal(int64(99650e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(350e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99900e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(100e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99474.85e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(225e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99989e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100109.9450e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99987e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100129.9350e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99949e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100509.7450e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100035e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99649.8250e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100010e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99899.9500e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Buy_3c(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 21e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 24e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 7e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99565e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(435e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99760e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(240e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99700e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(300e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99564.8140e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(63e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99969e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100303.8480e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99969e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100303.8480e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99969e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100303.8480e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100024e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99759.8800e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100030e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99699.85e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Buy_3d(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 9e8, 21e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 9e8, 24e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 9e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 11e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 6e8, 27e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 6e8, 22e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99361e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(639e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99989e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(11e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99784e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(216e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99730e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(270e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99385.7930e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(200e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99989e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100098.9505e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99973e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100242.8785e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99978e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100197.9010e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100014e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99783.9370e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(90e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99730e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(270e8), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Buy_4(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 5e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 2, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 6e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 3, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 9e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 4, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 10e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 9e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 9e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 3, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 7e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 4, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 5e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99695e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(305e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99709.8805e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(51e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99939e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100238.8805e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Buy_5(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 2, ctx)
	msgB := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 6e8, 5e8)
	...
	oid = GetOrderId(addr1, 0, ctx)
	msgS1 := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 10e8, 10e8)
	_, err = testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 1, ctx)
	msgS2 := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 9e8, 10e8)
	...
	msgC1 := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgB.Id)
	_, err = testClient.DeliverTxSync(msgC1, testApp.Codec)
	assert.NoError(err)

	msgC2 := order.NewCancelOrderMsg(addr1, "BTC-000_AXC", msgS1.Id)
	_, err = testClient.DeliverTxSync(msgC2, testApp.Codec)
	assert.NoError(err)

	msgC3 := order.NewCancelOrderMsg(addr1, "BTC-000_AXC", msgS2.Id)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99724.9998e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(275e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99959e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99999.9996e8), GetAvail(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(100032e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99739.8803e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(21e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99959e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100238.8801e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Buy_6(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 20e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 3, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 9e8, 6e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 7e8)
	msg.TimeInForce = 3
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 25e8)
	msg.TimeInForce = 3
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99701e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(299e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99716.8760e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(35e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99969e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100247.8760e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Maker_Buy_7(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 15e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(99700.9040e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(107e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99978e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100191.9040e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
}
...
func Test_Maker_Buy_8(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 1, "BTC-000_AXC", 8e8, 15e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 0, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 29e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99830e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(170e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99971e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(29e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99880e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(120e8), GetLocked(ctx, addr2, "AXC"))
	...
	assert.Equal(int64(99839.9385e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(37e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99971e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100236.8815e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100014.25e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99879.943e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(6e8), GetLocked(ctx, addr2, "AXC"))
}
...
func Test_Maker_Buy_9a(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 1, "BTC-000_AXC", 8e8, 3e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 1e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 17e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 6e8, 29e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99807e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(193e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99976e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(24e8), GetLocked(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(99838.9195e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100003e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99975.9880e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(99971e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100184.9075e8), GetAvail(ctx, addr2, "AXC"))
...
func Test_Maker_Buy_9b(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 1, "BTC-000_AXC", 6e8, 10e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 6e8, 55e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 6e8, 90e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99495e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(505e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99940e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(60e8), GetLocked(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(99519.7600e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100010e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99939.9700e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99910e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100539.7300e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
}
...
func Test_Maker_Buy_10a_new(t *testing.T) {
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 100e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99300e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(700e8), GetLocked(ctx, addr0, "AXC"))

	ctx = UpdateContextC(addr, ctx, 2)

	msgC := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msg.Id)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99999.9998e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
...
func Test_Maker_Buy_10b_new(t *testing.T) {
	...
	msgB := order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 7e8, 100e8)
	_, err := testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)
	...
	msgS := order.NewNewOrderMsg(addr1, oidS, 2, "BTC-000_AXC", 7e8, 50e8)
	...
	assert.Equal(int64(100050e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99299.8250e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(350e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99950e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100349.8250e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))

	ctx = UpdateContextC(addr, ctx, 3)

	msgC := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgB.Id)
	_, err = testClient.DeliverTxSync(msgC, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100050e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99649.8250e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99950e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100349.8250e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
