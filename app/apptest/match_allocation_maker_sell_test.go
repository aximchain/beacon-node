...
func Test_Maker_Sell_1a(t *testing.T) {
	...
	*/
	...
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 100e8)
	...
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 12e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 2, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 9e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 3, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(99120e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(880e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99369.6850e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99850e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100629.6850e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_1b(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 35e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 59e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
...
// change axc fee config to produce fees with 8+ decimal points
func Test_Maker_Sell_1c(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 75e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100090e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99444.73637503e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99875e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100554.73637503e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_2a(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 75e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99250e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(750e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99474.7375e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99900e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100524.7375e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_2b(t *testing.T) {
	...
	*/
	...
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 7e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99950e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100174.9125e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100174.9125e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100174.9125e8), GetAvail(ctx, addr3, "AXC"))
...
func Test_Maker_Sell_2d(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 31e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 18e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99690e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(310e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99690e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(310e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99690e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(310e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99782.8915e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99932e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100300.8495e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100174.9125e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	...
	assert.Equal(int64(99782.8915e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100031e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99782.8915e8), GetAvail(ctx, addr5, "AXC"))
...
func Test_Maker_Sell_2e(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99800e8), GetAvail(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(25e8), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99800e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(200e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99800e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(200e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99859.9300e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99925e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100256.53856655e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(38.3333e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100081.62606655e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(13.3333e8), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100081.62536690e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(13.3334e8), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100020e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99859.9300e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100020e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99859.9300e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Sell_2f(t *testing.T) {
	...
	*/
	...
	assert.Equal(int64(25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99975e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100069.9650e8), GetAvail(ctx, addr2, "AXC"))
...
func Test_Maker_Sell_3a(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 30e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 35e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 7e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 11e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 13e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 51e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99890e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(110e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99870e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(130e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99490e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(510e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(99922.9615e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99945e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100209.8950e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99965e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100244.8775e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100069.9650e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100013e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99908.9545e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100051e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99642.8215e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Sell_3c(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 21e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 24e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr3, 0, ctx)
	msg = order.NewNewOrderMsg(addr3, oid, 2, "BTC-000_AXC", 7e8, 30e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100031e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99767.8840e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99954e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100317.8410e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(7e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99976e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100167.9160e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99970e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100209.8950e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100031e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99767.8840e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100031e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99767.8840e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Sell_3d(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr4, 0, ctx)
	msg = order.NewNewOrderMsg(addr4, oid, 1, "BTC-000_AXC", 10e8, 27e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr5, 0, ctx)
	msg = order.NewNewOrderMsg(addr5, oid, 1, "BTC-000_AXC", 10e8, 22e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(30e8), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99730e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(270e8), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99780e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(220e8), GetLocked(ctx, addr5, "AXC"))
	...
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99929e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100321.8390e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99976e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100097.9510e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(10e8), GetLocked(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99970e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(30e8), GetLocked(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100027e8), GetAvail(ctx, addr4, "BTC-000"))
	assert.Equal(int64(99810.9055e8), GetAvail(ctx, addr4, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr4, "AXC"))
	assert.Equal(int64(100022e8), GetAvail(ctx, addr5, "BTC-000"))
	assert.Equal(int64(99845.9230e8), GetAvail(ctx, addr5, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr5, "AXC"))
}
...
func Test_Maker_Sell_4(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 9e8, 5e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 1, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 20e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 5e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 8e8, 7e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 2, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 9e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 3, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 6e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 4, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 5e8, 10e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 3, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr1, 4, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 6e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99521e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(479e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99585.8795e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(173e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99960e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100240.8795e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_5(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msgS := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 9e8, 5e8)
	...
	oid = GetOrderId(addr0, 3, ctx)
	msgB1 := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 6e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB1, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr0, 4, ctx)
	msgB2 := order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 5e8, 10e8)
	...
	msgC1 := order.NewCancelOrderMsg(addr1, "BTC-000_AXC", msgS.Id)
	_, err = testClient.DeliverTxSync(msgC1, testApp.Codec)
	assert.NoError(err)

	msgC2 := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgB1.Id)
	_, err = testClient.DeliverTxSync(msgC2, testApp.Codec)
	assert.NoError(err)

	msgC3 := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgB2.Id)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99630.9996e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(369e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99965e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99999.9998e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(35e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(100032e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99695.8791e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(63e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99965e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100240.8793e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_6(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 6e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99694e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(306e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(100031e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99751.8760e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99964e8), GetAvail(ctx, addr1, "BTC-000"))
...
func Test_Maker_Sell_7(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 15e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99794e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(206e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99964e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(36e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(99839.9200e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99964e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100159.9200e8), GetAvail(ctx, addr1, "AXC"))
...
func Test_Maker_Sell_8(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 29e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr1, 2, ctx)
	msg = order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 8e8, 15e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99710e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(290e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99772.8865e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99980e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100112.9435e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(5.25e8), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99985e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100113.943e8), GetAvail(ctx, addr2, "AXC"))
...
func Test_Maker_Sell_9a(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 8e8, 3e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 19e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 8e8, 17e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 1, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 6e8, 5e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99810e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(190e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(99823.912e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99997e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100023.988e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99978e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100151.9240e8), GetAvail(ctx, addr2, "AXC"))
...
func Test_Maker_Sell_9b(t *testing.T) {
	...
	*/
	...
	oid := GetOrderId(addr1, 0, ctx)
	msg := order.NewNewOrderMsg(addr1, oid, 2, "BTC-000_AXC", 7e8, 10e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 0, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 7e8, 90e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 7e8, 55e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)

	oid = GetOrderId(addr2, 1, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 6e8, 25e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99370e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(630e8), GetLocked(ctx, addr0, "AXC"))
	...
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100069.9650e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99920e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100559.7200e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
}
...
func Test_Maker_Sell_9c(t *testing.T) {
	...
	*/
	...
	oid = GetOrderId(addr0, 1, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 2e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr0, 3, ctx)
	msg = order.NewNewOrderMsg(addr0, oid, 1, "BTC-000_AXC", 10e8, 3e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	oid = GetOrderId(addr2, 0, ctx)
	msg = order.NewNewOrderMsg(addr2, oid, 2, "BTC-000_AXC", 9e8, 1e8)
	_, err = testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
	...
	assert.Equal(int64(100000e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(99715e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(285e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99997e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(3e8), GetLocked(ctx, addr1, "BTC-000"))
	...
	assert.Equal(int64(99738.883e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(27e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99997e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100026.9865e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99977e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(100206.8965e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr2, "BTC-000"))
}
...
func Test_Maker_Sell_10a_new(t *testing.T) {
	...
	oid := GetOrderId(addr0, 0, ctx)
	msg := order.NewNewOrderMsg(addr0, oid, 2, "BTC-000_AXC", 7e8, 100e8)
	_, err := testClient.DeliverTxSync(msg, testApp.Codec)
	assert.NoError(err)
...
func Test_Maker_Sell_10b_new(t *testing.T) {
	...
	msgS := order.NewNewOrderMsg(addr0, oidS, 2, "BTC-000_AXC", 7e8, 100e8)
	_, err := testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
	...
	msgB := order.NewNewOrderMsg(addr1, oidB, 1, "BTC-000_AXC", 7e8, 50e8)
	...
	assert.Equal(int64(99900e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(100349.8250e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(50e8), GetLocked(ctx, addr0, "BTC-000"))
	assert.Equal(int64(100050e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99649.8250e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "AXC"))

	ctx = UpdateContextC(addr, ctx, 3)

	msgC := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgS.Id)
	_, err = testClient.DeliverTxSync(msgC, testApp.Codec)
	assert.NoError(err)
...
/*
test #11: cancel maker order, no axc balance
*/
func Test_Maker_Sell_11_new(t *testing.T) {
	...
	msgS1 := order.NewNewOrderMsg(addr0, oidS1, 2, "BTC-000_AXC", 15e8, 10e8)
	_, err := testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)

	oidS2 := GetOrderId(addr0, 1, ctx)
	msgS2 := order.NewNewOrderMsg(addr0, oidS2, 2, "BTC-000_AXC", 15e8, 5e8)
	...
	msgS3 := order.NewNewOrderMsg(addr0, oidS3, 2, "BTC-000_AXC", 15e8, 6e8)
	_, err = testClient.DeliverTxSync(msgS3, testApp.Codec)
	assert.NoError(err)

	oidB := GetOrderId(addr1, 0, ctx)
	msgB := order.NewNewOrderMsg(addr1, oidB, 1, "BTC-000_AXC", 15e8, 12e8)
	_, err = testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)

	msgC := order.NewCancelOrderMsg(addr0, "BTC-000_AXC", msgS2.Id)
	_, err = testClient.DeliverTxSync(msgC, testApp.Codec)
	assert.NoError(err)
	...
	// match has not taken place, so no axc balance, fee charged in btc-000
	// 0.001 axc -> 0.001/10 = 0.0001
	...
	assert.Equal(int64(99820e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(180e8), GetLocked(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(99983.9999e8), GetAvail(ctx, addr0, "BTC-000"))
	assert.Equal(int64(179.9100e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(4e8), GetLocked(ctx, addr0, "BTC-000"))
	assert.Equal(int64(100012e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99819.9100e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "AXC"))
}
