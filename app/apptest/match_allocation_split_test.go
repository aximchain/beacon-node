...
func Test_Split_1a(t *testing.T) {
	...
	msgB1 := order.NewNewOrderMsg(addr0, oidB1, 1, "BTC-000_AXC", 2e8, 1e8)
	_, err := testClient.DeliverTxSync(msgB1, testApp.Codec)
	assert.NoError(err)

	oidB2 := GetOrderId(addr1, 0, ctx)
	msgB2 := order.NewNewOrderMsg(addr1, oidB2, 1, "BTC-000_AXC", 2e8, 1e8)
	_, err = testClient.DeliverTxSync(msgB2, testApp.Codec)
	assert.NoError(err)

	oidB3 := GetOrderId(addr2, 0, ctx)
	msgB3 := order.NewNewOrderMsg(addr2, oidB3, 1, "BTC-000_AXC", 2e8, 10e8)
	_, err = testClient.DeliverTxSync(msgB3, testApp.Codec)
	assert.NoError(err)

	oidS := GetOrderId(addr3, 0, ctx)
	msgS := order.NewNewOrderMsg(addr3, oidS, 2, "BTC-000_AXC", 2e8, 10e8)
	...
	assert.Equal(int64(9999799916660), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0.3332e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(10000083330000), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(9999799916670), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0.3334e8), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(10000833330000), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(9997999166670), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(3.3334e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100019.99e8), GetAvail(ctx, addr3, "AXC"))
...
func Test_Split_1b(t *testing.T) {
	...
	assert.Equal(int64(99997.9990e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(100008e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99979.9920e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(4e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(99990e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100019.99e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
}
...
func Test_Split_1c(t *testing.T) {
	...
	oidS := GetOrderId(addr3, 0, ctx)
	msgS := order.NewNewOrderMsg(addr3, oidS, 2, "BTC-000_AXC", 2e8, 1e7)
	_, err := testClient.DeliverTxSync(msgS, testApp.Codec)
	assert.NoError(err)
	...
	testApp.DexKeeper.UpdateLotSize("BTC-000_AXC", 1e8)
	...
	assert.Equal(int64(99997.9999e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(1.8000e8), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(99998e8), GetAvail(ctx, addr1, "AXC"))
	assert.Equal(int64(2e8), GetLocked(ctx, addr1, "AXC"))
	assert.Equal(int64(100000e8), GetAvail(ctx, addr2, "BTC-000"))
	assert.Equal(int64(99980e8), GetAvail(ctx, addr2, "AXC"))
	assert.Equal(int64(20e8), GetLocked(ctx, addr2, "AXC"))
	assert.Equal(int64(99999.9000e8), GetAvail(ctx, addr3, "BTC-000"))
	assert.Equal(int64(100000.1999e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
}
...
func Test_Split_3(t *testing.T) {
	...
	msgS1 := order.NewNewOrderMsg(addr0, oidS1, 2, "BTC-000_AXC", 1e4, 2e8)
	res, err := testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidS2 := GetOrderId(addr1, 0, ctx)
	msgS2 := order.NewNewOrderMsg(addr1, oidS2, 2, "BTC-000_AXC", 1e4, 20e8)
	res, err = testClient.DeliverTxSync(msgS2, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidS3 := GetOrderId(addr2, 0, ctx)
	msgS3 := order.NewNewOrderMsg(addr2, oidS3, 2, "BTC-000_AXC", 1e4, 12e8)
	res, err = testClient.DeliverTxSync(msgS3, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidB1 := GetOrderId(addr3, 0, ctx)
	msgB1 := order.NewNewOrderMsg(addr3, oidB1, 1, "BTC-000_AXC", 1e4, 10e8)
	...
	testApp.DexKeeper.UpdateLotSize("BTC-000_AXC", 1e9)
	...
	assert.Equal(int64(100000.00019990e8), GetAvail(ctx, addr0, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr0, "AXC"))
	assert.Equal(int64(99980e8), GetAvail(ctx, addr1, "BTC-000"))
	assert.Equal(int64(100000.00079960e8), GetAvail(ctx, addr1, "AXC"))
	...
	assert.Equal(int64(99999.99899950e8), GetAvail(ctx, addr3, "AXC"))
	assert.Equal(int64(0), GetLocked(ctx, addr3, "BTC-000"))
}
...
func Test_Split_4(t *testing.T) {
	...
	msgB := order.NewNewOrderMsg(addr0, oidB, 1, "BTC-000_AXC", 1, 1e12)
	res, err := testClient.DeliverTxSync(msgB, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidS1 := GetOrderId(addr1, 0, ctx)
	msgS1 := order.NewNewOrderMsg(addr1, oidS1, 2, "BTC-000_AXC", 1, 1e12)
	res, err = testClient.DeliverTxSync(msgS1, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidS3 := GetOrderId(addr2, 0, ctx)
	msgS3 := order.NewNewOrderMsg(addr2, oidS3, 2, "BTC-000_AXC", 1, 1e12)
	res, err = testClient.DeliverTxSync(msgS3, testApp.Codec)
	assert.NoError(err)
	fmt.Println(res)

	oidS4 := GetOrderId(addr3, 0, ctx)
	msgS4 := order.NewNewOrderMsg(addr3, oidS4, 2, "BTC-000_AXC", 1, 1e12)
