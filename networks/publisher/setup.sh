...
${cli} gov submit-list-proposal --chain-id ${chain_id} --from zc --deposit 200000000000:AXC --base-asset-symbol ${nnb_symbol} --quote-asset-symbol AXC --init-price 1000000000 --title "list NNB/AXC" --description "list NNB/AXC" --expire-time ${expire_time} --voting-period 5 --json
sleep 2
