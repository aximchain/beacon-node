...
sleep 2
result=$(expect ./send.exp ${cli_home} alice ${chain_id} "10000000000:AXC" ${carl_addr})
check_operation "Send Token" "${result}" "${chain_operation_words}"
sleep 2

#$ ./axccli --home ./testnodecli staking -h
#staking commands
#
#Usage:
#  axccli staking [command]
#
#Available Commands:
...
#      --home string       directory for config and data (default "/Users/owen/.axccli")
#  -o, --output string     Output format (text|json) (default "text")
#      --trace             print out full stack trace on errors
#
#Use "axccli staking [command] --help" for more information about a command.
